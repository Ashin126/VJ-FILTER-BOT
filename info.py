...
BOT_TOKEN = environ.get('BOT_TOKEN', "8227680825:AAGBEHOcxBB0J8BewTuqIMnhw3OTc4stIKg")
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002991243892') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# This Channel Is For When User Request Any File Name With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL', '-1002991243892')
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002991243892')
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None

# This Channel Is For /batch command file store.
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002991243892')).split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://ashirashinr_db_user:G73gGI4bHEcYycAH@ashinbia0.hi1jqud.mongodb.net/?retryWrites=true&w=majority&appName=Ashinbia0")   # IF Multiple Database Is False Then Fill Only This Database Url.
