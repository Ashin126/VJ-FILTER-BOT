...
BOT_TOKEN = environ.get('BOT_TOKEN', "8125576963:AAGAOK9X8fg9vQtDqK2QxQExBGYxpH8llBc")
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002383580301')).split()]  # For Multiple Id Use One Space Between Each.
